...
import com.example.project01_kggtalk.databinding.FragmentOpenTalkMainBinding;
...
public class OpenTalkMainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentOpenTalkMainBinding.inflate(inflater,container,false);
           //jsp <-> Controller : jsp는 이미 조회가 완료 된 내용을 Model을 통해서 받아와서 el문법으로 '보여주는 처리만함'.
        //view <-> Adapter : View(Recycler,Pager2)는 어댑터가 이미 결정한 모양을 보여주는 처리만함. (모든 처리는 Adapter 아이템 개수, 모양(레이아웃)
        //Adapter는 개발자가 모양을 커스텀하기 편하게 기본 구조를 갖춰놓고 나머지는 자유롭게 메소드를 구현해서 모양을 만ㅁ들게 해둠.
