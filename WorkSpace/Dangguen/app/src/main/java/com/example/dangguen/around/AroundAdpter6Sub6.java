...
import com.example.dangguen.databinding.ItemRecv6Sub6Binding;

import java.util.ArrayList;

public class AroundAdpter6Sub6 extends RecyclerView.Adapter<AroundAdpter6Sub6.ViewHolder> {

    ItemRecv6Sub6Binding binding;

    ArrayList<AroundDTO6Rcv6> list;
    Context context;

    public AroundAdpter6Sub6(ArrayList<AroundDTO6Rcv6> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        binding= ItemRecv6Sub6Binding.inflate(inflater,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull ItemRecv6Sub6Binding binding) {
