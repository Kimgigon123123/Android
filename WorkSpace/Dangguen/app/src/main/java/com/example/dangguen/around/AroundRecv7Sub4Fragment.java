...
public class AroundRecv7Sub4Fragment extends Fragment {
    ...
    public ArrayList<AroundDTO4Rcv1> getList() {
        ...
        list.add(new AroundDTO4Rcv1(R.drawable.around_img7_4_1,3600,60,"오늘필라테스","필라테스","방림점 백운점 둘 다 직접 운영합니다 소그룹 필라테스"));
        list.add(new AroundDTO4Rcv1(R.drawable.around_img7_4_2,2100,60,"우리동네점핑다이어트","기타실내운동시설","안녕하세요~ 점핑 감량 중량 다이어트 건강하게~ 우리동네"));
        list.add(new AroundDTO4Rcv1(R.drawable.around_img7_4_3,3100,60,"에이치투짐","헬스","탁트인 7층 씨티뷰, 명품 LEXCO사 운동기구 풀셋팅 24시"));
