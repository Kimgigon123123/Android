...
import com.example.dangguen.databinding.ItemRecv6Sub3Binding;

import java.util.ArrayList;

public class AroundAdpter6Sub3 extends RecyclerView.Adapter<AroundAdpter6Sub3.ViewHolder> {

    ItemRecv6Sub3Binding binding;

    ArrayList<AroundDTO6Rcv3> list;
    Context context;

    public AroundAdpter6Sub3(ArrayList<AroundDTO6Rcv3> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        binding= ItemRecv6Sub3Binding.inflate(inflater,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull ItemRecv6Sub3Binding binding) {
