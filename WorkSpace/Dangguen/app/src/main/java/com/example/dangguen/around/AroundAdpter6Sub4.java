...
public class AroundAdpter6Sub4 extends RecyclerView.Adapter<AroundAdpter6Sub4.ViewHolder> {

    ItemRecv6Sub4Binding binding;

    ArrayList<AroundDTO6Rcv4> list;
    Context context;

    public AroundAdpter6Sub4(ArrayList<AroundDTO6Rcv4> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        binding= ItemRecv6Sub4Binding.inflate(inflater,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull ItemRecv6Sub4Binding binding) {
