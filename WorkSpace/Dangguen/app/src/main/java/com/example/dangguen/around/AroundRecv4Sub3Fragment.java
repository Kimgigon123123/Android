...
public class AroundRecv4Sub3Fragment extends Fragment {
    ...
    public ArrayList<AroundDTO4Rcv3> getList() {
        ...
        list.add(new AroundDTO4Rcv3(R.drawable.dongne_img1,9620,355,10,"비타민마트","농성동","비타민마트 농성점 주말알바 구해요"));
        list.add(new AroundDTO4Rcv3(R.drawable.dongne_img1,10000,374,10,"광양돌판한우","화정동","주방두루치기1명 홀써빙 1명 모집합니다"));
        list.add(new AroundDTO4Rcv3(0,10000,400,10,"bhc농성점","농성동","김밥전문점 직원 찾아요"));
        return list;
    }
}