...
public class AroundRecv7Sub2Fragment extends Fragment {
    ...
    public ArrayList<AroundDTO4Rcv1> getList() {
        ...
        list.add(new AroundDTO4Rcv1(R.drawable.dongne_img1,1100,30,"윤코치(PT)","헬스","안녕하세요 윤준현 트레이너 입니다. Certificate 생활스포츠지도사 2급"));
        list.add(new AroundDTO4Rcv1(R.drawable.dongne_img1,1200,30,"태양휘트니스","헬스","화정동 1403번지 태양 사우나 4층에 위치 연중무휴"));
        list.add(new AroundDTO4Rcv1(R.drawable.dongne_img1,1300,30,"리메디 필라테스 화정점","필라테스","캐나다 스탓 필라테스기구를 사용하는 스탓기구"));
